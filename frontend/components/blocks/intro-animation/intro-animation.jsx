...
const IntroAnimation = () => {
    ...
    useEffect(() => {
        const context = gsap.context(() => {
            ...
            longIntroAnimationTimelineRef.current.to('.intro-animation .intro-animation__inner', { display:  'none' }, 7);
        }, introAnimationRef);
    ...
    useEffect(() => {
        const context = gsap.context(() => {
            ...
            shortIntroAnimationTimelineRef.current.to('.intro-animation .intro-animation__inner', { opacity: 0, duration: 2 }, 0);
            shortIntroAnimationTimelineRef.current.to('.intro-animation .intro-animation__inner', { display:  'none' }, 2);
        }, introAnimationRef);
        return () => context.revert();
    }, []);
