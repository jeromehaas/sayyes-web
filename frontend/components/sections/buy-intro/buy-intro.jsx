...
const BuyIntro = () => {
	...
	return (
		<Section className="buy-intro">
			...
			<Picture  className="buy-intro__picture" src="/images/general/general-01.webp" alt="Brautkleid" figure={{ form: "up", position: 'top-left', borderColor: 'blue', ordinate: 'back', backgroundColor: 'blue' }}	 />
