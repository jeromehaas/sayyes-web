		...
		<Section className="buy-form">
			<form className="buy-form__container container" onSubmit={ handleSubmit((values) => handleDispatch(values))}>
				...
				<fieldset className="container__try-on try-on">
					...
					<InputSelection className="try-on__package" label="Welche Anprobe wünsche ich mir?" id="package" value={ values['package']} register={ register } header="Anprobepaket" name="package" type="radio" errors={ formState.errors } validation={{ validate: (value) => value !== null }} errorText="Bitte wähle ein Paket" options={[ { id: "fun-and-friends", value: "Fun and Friends", label: "Fun & Friends", info: '(75.-)' },{ id: "bubbles-food-and-friends", value: "Bubbles, Food & Friends", label: "Bubbles, Food & Friends", info: '(75.- + 15.- pro Person)'  },]}/>
				</fieldset>
