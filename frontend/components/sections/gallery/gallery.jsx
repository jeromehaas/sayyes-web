		...
		<Section className="gallery">
			...
			<div className="gallery__collection collection">
				{ data && data.map((image, index) => {
					return (
						<div className="collection__item item" onClick={ () => { return handleClick(index); } } key={ index }>
			...
			<div className="gallery__slider slider" onTouchStart={ handleTouchStart } onTouchMove={ handleTouchMove } onTouchEnd={ handleTouchEnd } ref={ sliderRef }>
				<div className="slider__header header">
					...
					<button className="header__back back" onClick={ handleClose } type="button">
				...
				<div className="slider__content">
					...
					<div className="content__container">
						<Image className="content__image" src={ data[categoryIndex].attributes.images.data[imageIndex]?.attributes.url } width={ 850 } height={ 850 } quality={ 75 } alt="Brautkleid" priority />
					</div>
