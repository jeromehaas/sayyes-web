    ...
    return (
        <Section className="about-intro">
            ...
            <div className="about-intro__pictures pictures">
				<Picture  className="pictures__item" src="/images/placeholder/placeholder.png" alt="image" figure={{ form: "sym", position: 'top-right', borderColor: 'blue', backgroundColor: 'blue', ordinate: 'back' }}	 />
				<Picture  className="pictures__item" src="/images/placeholder/placeholder.png" alt="image" figure={{ form: "sym", position: 'bottom-left', borderColor: 'blue', backgroundColor: '' }}	 />
            </div>
